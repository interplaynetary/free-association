...
describe("holster.user.on", () => {
  ...
  test("calling on without get callback null", (_t, done) => {
    user.on(data => {
  ...
  test("on for property then update - event", (_t, done) => {
  ...
  test("on for different property - no event", (_t, done) => {
  ...
  test("on for property two updates - two events", (_t, done) => {
  ...
  test("on for properties in for loop", (_t, done) => {
    ;(async () => {
      for (let i = 0; i < 5; i++) {
  ...
  test("on with get flag set - data returned", (_t, done) => {
  ...
  test("chained next before on", (_t, done) => {
  ...
  test("on and put object in graph format", (_t, done) => {
    const plain = {
      key: "plain value",
      number: 42,
    }
  ...
  test("on and put nested object", (_t, done) => {
    const nested = {
      key: "nested key",
      child: {
        has: "child key",
