...
describe("holster.secure", () => {
  ...
  test("empty key callback null", (_t, done) => {
    holster.get("", data => {
  ...
  test("null key callback null", (_t, done) => {
  ...
  test("underscore as key callback null", (_t, done) => {
    holster.get("_", data => {
      assert.equal(data, null)
      done()
    })
  ...
  test("get unknown key callback null", (_t, done) => {
  ...
  test("next chained unknown keys callback null", (_t, done) => {
  ...
  test("put string on root error", (_t, done) => {
  ...
  test("user put and get string", (_t, done) => {
  ...
  test("user chained get before put", (_t, done) => {
    user
      .get("hello")
      .next("world!")
      .put("ok", err => {
  ...
  test("user put and get object in graph format", (_t, done) => {
    const plain = {
      key: "plain value",
      true: true,
      false: false,
  ...
  test("user put object to null", (_t, done) => {
  ...
  test("user chained get before put object in graph format", (_t, done) => {
    const plain = {
      key: "hello plain value",
    }
    user
  ...
  test("user put and get nested object", (_t, done) => {
    const nested = {
      key: "nested value",
      child: {
        has: "child value",
