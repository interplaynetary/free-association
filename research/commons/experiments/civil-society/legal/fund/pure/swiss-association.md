...
Current protocol specifications are maintained at [playnet.gitbook.io/docs/decider/decider](https://playnet.gitbook.io/docs/decider/decider) and may be updated via Decider process.
