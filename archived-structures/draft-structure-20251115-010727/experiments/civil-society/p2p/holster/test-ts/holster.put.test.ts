...
describe("holster.put", () => {
  ...
  test("put and get string on root", (_t, done) => {
  ...
  test("put value to null on root", (_t, done) => {
  ...
  test("put and get true on root", (_t, done) => {
  ...
  test("put and get false on root", (_t, done) => {
  ...
  test("put and get number on root", (_t, done) => {
  ...
  test("put and get values in for loop on root", (_t, done) => {
    for (let i = 0; i < 5; i++) {
  ...
  test("put and get object on root in graph format", (_t, done) => {
    const plain = {
      key: "plain value",
      true: true,
      false: false,
  ...
  test("put object to null on root", (_t, done) => {
