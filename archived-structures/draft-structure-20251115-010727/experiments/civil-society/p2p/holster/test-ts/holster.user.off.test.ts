...
describe("holster.user.off", () => {
  ...
  test("calling off without get callback null", (_t, done) => {
    user.off(data => {
  ...
  test("off with cb for property then update - no event", (_t, done) => {
    const cb = data => {
  ...
  test("off no cb for property then update - no event", (_t, done) => {
