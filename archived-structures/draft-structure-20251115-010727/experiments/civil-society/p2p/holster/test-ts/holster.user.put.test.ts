...
describe("holster.user.put", () => {
  ...
  test("put and get string", (_t, done) => {
  ...
  test("put value to null", (_t, done) => {
  ...
  test("put and get false", (_t, done) => {
  ...
  test("put and get number", (_t, done) => {
  ...
  test("put and get values in for loop", (_t, done) => {
    ;(async () => {
      for (let i = 0; i < 5; i++) {
  ...
  test("chained get before put", (_t, done) => {
    user
      .get("hello")
      .next("world!")
      .put("ok", err => {
  ...
  test("more chained gets before put", (_t, done) => {
    user
      .get("1")
      .next("2")
      .next("3")
  ...
  test("put and get object in graph format", (_t, done) => {
    const plain = {
      key: "plain value",
      true: true,
      false: false,
  ...
  test("put object to null", (_t, done) => {
  ...
  test("chained get before put object in graph format", (_t, done) => {
    const plain = {
  ...
  test("put and get nested object", (_t, done) => {
    const nested = {
      key: "nested value",
      child: {
        has: "child value",
  ...
  test("chained get before put nested object", (_t, done) => {
    const nested = {
  ...
  test("put and get two nested objects", (_t, done) => {
    const two = {
  ...
  test("put and get multiple nested object", (_t, done) => {
    const multiple = {
  ...
  test("put string with set", (_t, done) => {
  ...
  test("put object with set", (_t, done) => {
    const set1 = {
      key: "value 1",
      child: "child value 1",
    }
  ...
  test("get number using public key - logged in", (_t, done) => {
  ...
  test("get number using public key - logged out", (_t, done) => {
    user.leave()
  ...
  test("chained get in graph format using public key", (_t, done) => {
    const plain = {
      key: "hello plain value",
    }
  ...
  test("get nested object using public key", (_t, done) => {
    const nested = {
      key: "nested value",
      child: {
        has: "child value",
  ...
  test("chained get nested object using public key", (_t, done) => {
    const nested = {
      key: "hello nested value",
      child: {
        has: "hello child value",
