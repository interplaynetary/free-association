...
- [Try the System](getting-started/try-it.md) - Live demo
- [Quick Start Guide](getting-started/quick-start.md) - 5-minute overview
...
**Architecture:**
- [How It's Built](architecture/README.md) - System Design
- [Distributed Architecture](architecture/distributed-architecture.md) - Core Patterns

## Implementation

- [For Organizations](implementation/organizations.md) - Pilot programs
- [For Developers](implementation/developers.md) - Technical setup

## Additional Resources

- [Use Cases](use-cases/README.md) - Real-world examples
- [Coalition](coalition/participation-framework.md) - Join the coalition
- [Reference](reference/glossary.md) - Glossary, Mathematics, Protocol Spec
- [Project Info](project/license.md) - License, Governance, Contact
