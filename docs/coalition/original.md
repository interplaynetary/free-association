...
**Draft Participation Framework for Review** \[Nov 18, 15:41\]  
**Drafted by:** Initial working group convened at COP30 2025 coordination sessions

This coalition consists of entities experimenting with **Digital Public Goods (DPGs)** for voluntary coordination. The coalition proposes a re-engineering of how collective action and resource allocation can be coordinated. 

**The key insight is separating:**

1. **Publishing** (what is, what I have/need)  
2. **Derivation** (what we can infer collectively)  
   1. **Recognition** (who/what contributes)  
   2. **Allocation** (how we divide our capacities)
