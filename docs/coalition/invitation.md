...
1. **Quick briefing:** Schedule 30 minutes at [calendly.com/free-association/30min](http://calendly.com/free-association/30min)
2. **Questions/Contact:** Email [coalition@openassociation.org](mailto:coalition@openassociation.org)
3. **Drop-in:** Visit us at COP30 sessions (locations above)
4. **More information:** [openassociation.org](http://openassociation.org) and [docs.openassociation.org](http://docs.openassociation.org)
...
**Priority:** Acknowledgement of contributions to the realization of one's priorities/values.
...
* **Mozambique** attributes **Doctors Without Borders** 30%
  **Doctors Without Borders** attributes **Mozambique** 30%
  → **MR = 30%**

* **Mozambique** attributes **Red Cross** 15%
  **Red Cross** attributes **Mozambique** 8%
  → **MR = 8%**

* **WHO** attributes **Doctors Without Borders** 15%
  **Doctors Without Borders** attributes **WHO** 15%
  → **MR = 15%**
...
* [Detailed Participation Framework](participation-framework.md)
* [Recognition Mathematics](recognition-mathematics.md)
* [Coordination Sessions Details](coordination-sessions.md)
* [Founding Process](founding-process.md)
