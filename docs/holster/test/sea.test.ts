...
describe("SEA", () => {
  ...
  test("encrypt and decrypt string await", (_t, done) => {
    ;(async () => {
      const pair = await SEA.pair()
  ...
  test("encrypt and decrypt with wrong key", (_t, done) => {
    ;(async () => {
  ...
  test("encrypt and decrypt string callback", (_t, done) => {
    SEA.pair(pair => {
  ...
  test("encrypt and decrypt object await", (_t, done) => {
    ;(async () => {
      const pair = await SEA.pair()
  ...
  test("encrypt and decrypt object callback", (_t, done) => {
    SEA.pair(pair => {
  ...
  test("sign and verify string await", (_t, done) => {
    ;(async () => {
      const pair = await SEA.pair()
  ...
  test("sign and verify with wrong key", (_t, done) => {
    ;(async () => {
      const alice = await SEA.pair()
      const bob = await SEA.pair()
  ...
  test("sign and verify string callback", (_t, done) => {
    SEA.pair(pair => {
  ...
  test("sign and verify object await", (_t, done) => {
    ;(async () => {
      const pair = await SEA.pair()
  ...
  test("sign and verify object callback", (_t, done) => {
    SEA.pair(pair => {
  ...
  test("work with salt encrypt string callback", (_t, done) => {
  ...
  test("work with salt encrypt string await", (_t, done) => {
    ;(async () => {
  ...
  test("work with salt encrypt object callback", (_t, done) => {
    SEA.work("hello", "salt", work => {
  ...
  test("work with salt encrypt object await", (_t, done) => {
    ;(async () => {
      const work = await SEA.work("hello", "salt")
  ...
  test("work no salt encrypt string callback", (_t, done) => {
    SEA.work("hello", work => {
      SEA.encrypt("hello work", work, enc => {
        SEA.decrypt(enc, work, dec => {
          assert.equal(dec, "hello work")
  ...
  test("work no salt encrypt string await", (_t, done) => {
    ;(async () => {
  ...
  test("work no salt encrypt object callback", (_t, done) => {
    SEA.work("hello", work => {
      SEA.encrypt({test: "hello work"}, work, enc => {
        SEA.decrypt(enc, work, dec => {
          assert.deepEqual(dec, {test: "hello work"})
  ...
  test("work no salt encrypt object await", (_t, done) => {
    ;(async () => {
      const work = await SEA.work("hello")
      const enc = await SEA.encrypt({test: "hello work"}, work)
      const dec = await SEA.decrypt(enc, work)
  ...
  test("secret string callback", (_t, done) => {
    SEA.pair(alice => {
      SEA.pair(bob => {
  ...
  test("secret string await", (_t, done) => {
    ;(async () => {
      const alice = await SEA.pair()
      const bob = await SEA.pair()
  ...
  test("secret object callback", (_t, done) => {
    SEA.pair(alice => {
      SEA.pair(bob => {
        SEA.secret(bob, alice, to => {
  ...
  test("secret object await", (_t, done) => {
    ;(async () => {
      const alice = await SEA.pair()
      const bob = await SEA.pair()
      const to = await SEA.secret(bob, alice)
