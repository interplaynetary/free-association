...
describe("radisk with cache", () => {
  ...
  test("write and read from memory with cache", (_t, done) => {
    radisk("key", "value", () => {})

    // Reading after write means radisk.batch is still available.
    radisk("key", (_err, value) => {
      assert.equal(value, "value")
      done()
    })
  })

  test("read from store with cache", (_t, done) => {
  ...
  test("write and read value with state and cache", (_t, done) => {
  ...
  test("write and read a plain object with cache", (_t, done) => {
  ...
  test("write a plain object with state and cache", (_t, done) => {
  ...
  test("write and read a soul relation with cache", (_t, done) => {
    const rel = {"#": "soul"}
    radisk("key", rel)
    setTimeout(() => {
      radisk("key", (_err, value) => {
  ...
  test("write and read a soul relation with state and cache", (_t, done) => {
    const rel = [{"#": "soul"}, 1234]
    radisk("key", rel)
    setTimeout(() => {
      radisk("key", (_err, value) => {
  ...
  test("write and read value with newline and cache", (_t, done) => {
    radisk("key", "value\ncontinued")
    setTimeout(() => {
      radisk("key", (_err, value) => {
        assert.equal(value, "value\ncontinued")
  ...
  test("write and read value with newline and state and cache", (_t, done) => {
    radisk("key", ["value\ncontinued", 12345])
    setTimeout(() => {
      radisk("key", (_err, value) => {
  ...
  test("write more than batch size with cache", (_t, done) => {
    radisk("keyA", "valueA")
    radisk("keyB", "valueB")
    radisk("keyC", "valueC")
    setTimeout(() => {
      radisk("keyA", (_err, value) => {
  ...
  test("write and read value bigger than file size with cache", (_t, done) => {
    radisk("newFile", big)
    radisk("newFile", (_err, value) => {
  ...
  test("write and read a small value after split with cache", (_t, done) => {
    radisk("small", "small value")
    radisk("small", (_err, value) => {
  ...
  test("write small value to newFile with cache", (_t, done) => {
  ...
  test("write big value to first file with cache", (_t, done) => {
    radisk("keyA", big)
    radisk("keyA", (_err, value) => {
      assert.equal(value, big)
      done()
  ...
  test.skip("add to last file with cache", (_t, done) => {
    ...
    setTimeout(() => {
      radisk("smallContinued", (_err, value) => {
  ...
  test("set a key to null and add a value to that file with cache", (_t, done) => {
    radisk("keyC", null)
    radisk("keyC", (_err, value) => {
      assert.equal(value, null)
    })
    radisk("keyD", "valueD")
    radisk("keyD", (_err, value) => {
      assert.equal(value, "valueD")
      done()
    })
  })

  test("set first keys to null with cache", (_t, done) => {
    radisk("key", null)
    radisk("key", (_err, value) => {
      assert.equal(value, null)
    })
