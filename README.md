...
*Free-Association* is a legitimate alternative to capitalism that allows for the *spontaneous self-actualization of all through each other* without any centralized control, planning, private-property, state intervention!
...
3. Your **Mutual Recognition** with another is the minimum of your recognition of each other.
    - For example: If you are 50% of my *total-recognition*, and I am 10% of your *total-recognition*, our mutual-recognition is 10%, the minimum of the both.
      ...
      - This is *mutual-recognition of mutual-contribution towards each other's self-actualization*.
