...
console.log('[TRACE] src/lib/network/slot-subscriptions.svelte.ts: <module scope>');

// ═══════════════════════════════════════════════════════════════════
// UNIFIED STORES (Mesh-backed via createStore)
// ═══════════════════════════════════════════════════════════════════
...
export function initializeCapacitySubscriptions() {
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: initializeCapacitySubscriptions');
	slotSubscriptions.initialize();
	slotFilters.initialize();
	console.log('[SLOT-SUBS] Initialized unified stores');
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: initializeCapacitySubscriptions');
}
...
export async function cleanupCapacitySubscriptions() {
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: cleanupCapacitySubscriptions');
	await slotSubscriptions.cleanup();
	await slotFilters.cleanup();
	capacityCache.set({});
	needCache.set({});
	console.log('[SLOT-SUBS] Cleaned up');
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: cleanupCapacitySubscriptions');
}
...
export function subscribeToSlots(
	...
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: subscribeToSlots', { pubkey, types });
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: subscribeToSlots');
}
...
export function unsubscribeFromSlots(pubkey: string): void {
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: unsubscribeFromSlots', { pubkey });
	const currentSubs = get(slotSubscriptions);
	if (!currentSubs) {
		console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: unsubscribeFromSlots (no subs)');
		return;
	}
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: unsubscribeFromSlots');
}
...
export function updateSlotSubscription(
	...
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: updateSlotSubscription', { pubkey, types });
	const currentSubs = get(slotSubscriptions) || {};
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: updateSlotSubscription');
}
...
export function createSlotFilter(
	...
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: createSlotFilter');
	const now = Date.now();
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: createSlotFilter', { filter_id });
...
export function updateSlotFilter(filter_id: string, updates: Partial<SlotFilter>): void {
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: updateSlotFilter', { filter_id });
	const currentFilters = get(slotFilters);
	if (!currentFilters) {
		console.warn(`[SLOT-SUBS] No filters loaded`);
		console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: updateSlotFilter (no filters)');
		return;
	}
	...
	if (!existingFilter) {
		...
		console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: updateSlotFilter (not found)');
		return;
	}
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: updateSlotFilter');
}
...
export function deleteSlotFilter(filter_id: string): void {
	console.log('[TRACE] [ENTER] src/lib/network/slot-subscriptions.svelte.ts: deleteSlotFilter', { filter_id });
	const currentFilters = get(slotFilters);
	if (!currentFilters) {
		console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: deleteSlotFilter (no filters)');
		return;
	}
	...
	console.log('[TRACE] [EXIT] src/lib/network/slot-subscriptions.svelte.ts: deleteSlotFilter');
}
