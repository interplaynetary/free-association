...
// Mock all SvelteKit and Mesh dependencies before importing anything
...
describe('Path Prefixing Integration', () => {
	...
	describe('Output paths', () => {
		it('should prefix output mesh paths during execution', async () => {
...
describe('Edge Cases with Runtime', () => {
	...
	it('should handle very long mesh paths', async () => {
