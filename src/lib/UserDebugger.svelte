...
<div class="debugger">
    ...
    <div class="actions">
        <button on:click={createTestUser}>
            Create Test User
        </button>
        <button on:click={handleClearCache}>
            Clear Cache
        </button>
        <button on:click={handleCopyDebugInfo}>
            Copy Debug Info
        </button>
    </div>
                ...
                {#each $infoStore.users as user}
                    <li>
                        ...
                        <div class="user-actions">
                            <span class="status-dot" class:online={user.online} title={user.online ? 'Online' : 'Offline'}></span>
                            <button on:click={() => toggleUserStatus(user.id, true)} class="small-btn">Set Online</button>
                            <button on:click={() => toggleUserStatus(user.id, false)} class="small-btn">Set Offline</button>
                        </div>
                    </li>
                {/each}
            </ul>
