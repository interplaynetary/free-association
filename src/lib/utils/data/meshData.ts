/**
 * Writes data at a specific path inside a mesh user's account.
 * 
 * @param user - The authenticated mesh user instance
...
/**
 * Reads data from a specific path inside a mesh user's account.
 * 
 * @param user - The authenticated mesh user instance (or unauthenticated for public keys)
...
/**
 * Listens for changes at a specific path inside a mesh user's account.
 * 
 * @param user - The authenticated mesh user instance
