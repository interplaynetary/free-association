<script lang="ts">
	...
	function handleDragStart(e: DragEvent) {
		...
		unconferenceState.startDragging(note);
		isDragging = true;
...
<style>
	...
	/* Color-specific text adjustments */
	.sticky-note[style*="rgb(255, 255, 255)"] .note-content,
	.sticky-note[style*="#FFFFFF"] .note-content,
	.sticky-note[style*="#ffffff"] .note-content,
	.sticky-note[style*="#FFEAA7"] .note-content,
	.sticky-note[style*="#ffeaa7"] .note-content {
		color: #333;
	}

	.sticky-note[style*="rgb(0, 0, 0)"] .note-content,
	.sticky-note[style*="#000000"] .note-content,
	.sticky-note[style*="#000000"] .note-content {
		color: #fff;
	}
</style>