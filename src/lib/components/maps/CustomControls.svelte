...
>
	...
	<CustomControl position={controlPosition} class="text-gray-900">
		...
		<button
			...
			onclick={() => (controlPosition = 'top-right')}><ArrowUpRight class="w-5" /></button
		>
		<button
			class="flex! items-center justify-center"
			onclick={() => (controlPosition = 'bottom-right')}><ArrowDownRight class="w-5" /></button
		>
		<button
			class="flex! items-center justify-center"
			onclick={() => (controlPosition = 'bottom-left')}><ArrowDownLeft class="w-5" /></button
		>
	</CustomControl>
