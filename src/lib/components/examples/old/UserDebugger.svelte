<script lang="ts">
	...
	// Create test users directly in the users list
				...
				{#each $infoStore.users as user}
					<li>
						...
						<div class="user-actions">
							...
							></span>
							<button onclick={() => toggleUserStatus(user.id, true)} class="small-btn"
								>Set Online</button
							>
							<button onclick={() => toggleUserStatus(user.id, false)} class="small-btn"
								>Set Offline</button
							>
						</div>
					</li>
