...
<script lang="ts">
  ...
  export let theme: "light" | "dark" | "white" | "black" | "grayscale" =
    "light";
      ...
      if (useTheme && pmtilesUrl) {
        try {
          ...
          mapStyle = {
            ...
            layers: protomapsThemes.default(
              pmtilesSourceName,
              theme as any,
              "en",
            ),
          ...
          console.log(
            "Creating themed map with layers:",
      ...
      map = new maplibregl.Map({
        ...
        style:
          ...
          ({
            version: 8,
            glyphs:
              "https://protomaps.github.io/basemaps-assets/fonts/{fontstack}/{range}.pbf", // Always include glyphs
          ...
          if (pmtilesSourceType === "vector" && !mapStyle) {
            ...
            for (const sourceLayer of commonSourceLayers) {
              try {
                ...
                console.log(
                  `Source layer "${sourceLayer}" not available or error adding it`,
                );
              }
            }
          }
  ...
  export function setTheme(
    themeId: "light" | "dark" | "white" | "black" | "grayscale",
  ): void {
    if (!map) return;
  ...
  export function addLayer(layer: any) {
    if (map) {
      ...
      const customId = layer.id.startsWith("custom-")
        ? layer.id
        : `custom-${layer.id}`;
      layer.id = customId;
      map.addLayer(layer);
  ...
  function logAllLayers() {
    ...
    try {
      ...
      style.layers.forEach((layer) => {
        ...
        console.log(
          `Layer: ${layer.id}, Type: ${layer.type}, Visibility: ${visibility}`,
        );
      });
      console.log("=========================");
    } catch (error) {
  ...
  {#if showStyleControls}
    ...
    {#if showBasemapPanel}
      <div class="side-panel basemap-panel">
        <div class="panel-header">
          ...
          <button
            class="close-button"
            onclick={() => (showBasemapPanel = false)}>×</button
          >
        </div>
    ...
    {#if showLayersPanel}
      <div class="side-panel layers-panel">
        <div class="panel-header">
          <h3>Layers</h3>
          <button class="close-button" onclick={() => (showLayersPanel = false)}
            >×</button
          >
        </div>
        <div class="panel-content">
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleLabels(showLabels)}
                />
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleRoads(showRoads)}
                />
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleBuildings(showBuildings)}
                />
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleWater(showWater)}
                />
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleLandmarks(showLandmarks)}
                />
            ...
            <div class="layer-item">
              <label class="layer-toggle">
                <input
                  ...
                  on:change={() => toggleLanduse(showLanduse)}
                />
