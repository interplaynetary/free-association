...
import {
	...
	type PlacementsMap,
	type UsersMap
} from '$lib/state/unconference/unconference';
...
export const allRooms = derived([userRooms, networkRooms], ([$userRooms, $networkRooms]) => {
...
export const allNotes = derived([userNotes, networkNotes], ([$userNotes, $networkNotes]) => {
...
// Get unplaced notes
export const unplacedNotes = derived([allNotes, allPlacements], ([$allNotes, $allPlacements]) => {
