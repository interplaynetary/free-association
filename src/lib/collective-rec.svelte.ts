...
import { updateCapacityMembership, shouldUpdateCapacityMembership } from '$lib/membership.svelte';
...
export function slotsCompatible(
	needSlot: import('$lib/schema').NeedSlot,
	availabilitySlot: import('$lib/schema').AvailabilitySlot
): boolean {
...
export function computeAllocations(
	...
	if (capacity.auto_update_members_by_mrd && recognitionData && currentMembers.length > 0) {
		...
		capacity.members = membershipResult.updatedMembers;
