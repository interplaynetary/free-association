...
/* package free-association-0.1.0.0 */
#ifndef VERSION_free_association
#define VERSION_free_association "0.1.0.0"
#endif /* VERSION_free_association */
#ifndef MIN_VERSION_free_association
#define MIN_VERSION_free_association(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_free_association */
...
#define CURRENT_COMPONENT_ID "free-association-0.1.0.0-inplace-free-association"
